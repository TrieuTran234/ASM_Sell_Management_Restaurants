		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="/form/thucDon" class="nav-link">Thực đơn</a></li>
					<li class="nav-item"><a href="/form/taiKhoan/dangNhap" class="nav-link">Đăng nhập</a></li>
				</ul>
			</div>
		</div>
	</nav>
				...
				<div
					...
					<div
						...
						<div class="text mt-md-5">
							<h1 class="mb-4">
								Eat Healthy <br> and Natural Foods
							</h1>
							<p>A small river named Duden flows by their place and
								supplies it with the necessary regelialia. It is a paradisematic
								country.</p>
							<p>
								<a href="#" class="btn btn-primary px-4 py-3 mt-3">Book A
									Table</a>
							</p>
						</div>
					</div>
				...
				<div class="col-lg-10">
					<div class="row d-md-flex align-items-center">
						...
						<div
							...
							<div class="block-18">
								<div class="text">
									<strong class="number" data-number="20000">0</strong> <span>Happy
										Customers</span>
								</div>
							</div>
						</div>
